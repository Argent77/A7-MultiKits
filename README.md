[![GitHub release (latest by date)](https://img.shields.io/github/v/release/Argent77/A7-MultiKits?color=darkred&include_prereleases&label=latest%20release)](https://github.com/Argent77/A7-MultiKits/releases/latest)
...
[![Language](https://img.shields.io/static/v1?label=language&message=English%20%7C%20French%20%7C%20German%20%7C%20Polish%20%7C%20Simplified%20Chinese&color=limegreen)](https://github.com/Argent77/A7-MultiKits)
...
**Note:** Manual kit selections are stored in the "A7-MultiKits-manual.ini" file, which can be used for a quick and simple reinstallation by the automated kit installation method explained below.
