...
- class:
  ...
  looked up in CLASS.IDS with a resource editor or in IESDP: https://gibberlings3.github.io/iesdp/files/ids/bgee/class.htm
- kit1 / kit2 / kit3:
  Symbolic names or numeric values of up to three kits that make up the new multiclass kit. Only one kit per base class
  is allowed. Name and numeric value can be looked up in KIT.IDS with a resource editor. Vanilla game kits can also be
  looked up in the IESDP: https://gibberlings3.github.io/iesdp/files/ids/bgee/kit.htm
- title:
...
- name:
  ...
  - Omit or leave blank to autogenerate the internal kit name (recommended).
